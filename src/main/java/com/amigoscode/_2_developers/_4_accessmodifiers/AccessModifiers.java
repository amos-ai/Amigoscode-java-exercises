...
import com.amigoscode._2_developers._13_staticmembers.StaticExercises;
...
public class AccessModifiers {
    ...
    static String packageGreeting(){
        return "Hello from package-private method";
    }
    ...
    public static void main (String[] args) {
        AccessModifiers demonstrate = new AccessModifiers();
        System.out.println(demonstrate.demonstrateInternalAccess());
        demonstrate.getSecret();
