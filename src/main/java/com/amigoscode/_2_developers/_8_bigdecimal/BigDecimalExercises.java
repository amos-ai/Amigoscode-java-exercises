...
public class BigDecimalExercises {
    ...
    public static BigDecimal createFromString(String value) {
        ...
        BigDecimal string = new BigDecimal(value);
        return string;
    }
    ...
    public static BigDecimal divideValues(BigDecimal a, BigDecimal b, int scale) {
        ...
        BigDecimal round = a.divide(b, scale, RoundingMode.HALF_UP);
        return round;
    }
    ...
    public static void demonstrateDoubleProblem() {
        ...
        System.out.println("BigDecimal converts the String constructor to a decimal point with precision.");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=== Comparison ===");
        BigDecimal val1 = new BigDecimal("6.0");
