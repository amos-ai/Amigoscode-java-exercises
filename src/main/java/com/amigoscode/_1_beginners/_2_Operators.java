...
public class _2_Operators {
    ...
    static void main() {
        ...
        int number = 10;
        String result = (number % 2 == 1) ? "odd (result is 1)" : "even (result is 0)";
        System.out.println(result);
        /*
        if (number % 2 == 1) {
            System.out.println("odd (result is 1)" );
        } else {
            System.out.println("even (result is 0)");
        } */
        ...
        System.out.println(hasLiscense && hasInsurance);
        System.out.println(hasLiscense || hasInsurance);
        System.out.println(!hasLiscense);
